...
#define SPELL_ATTR_DONT_DISPLAY_SPELL_RESULT      0x00000001            // 0
...
#define SPELL_ATTR_IS_REPLENISHMENT               0x00000008            // 3 not set in 2.4.2
#define SPELL_ATTR_IS_ABILITY                     0x00000010            // 4 client puts 'ability' instead of 'spell' in game strings for these spells
...
#define SPELL_ATTR_HIDE_IN_COMBAT_LOG             0x00000100            // 8 this attributes controls whether spell appears in combat logs
...
#define SPELL_ATTR_NEGATIVE                       0x04000000            // 26 Almost all negative spell have it
...
#define SPELL_ATTR_EX_FARSIGHT                    0x00002000            // 13
...
#define SPELL_ATTR_EX_NOT_RESET_AUTO_ACTIONS      0x00020000            // 17 for auras SPELL_AURA_TRACK_CREATURES, SPELL_AURA_TRACK_RESOURCES and SPELL_AURA_TRACK_STEALTHED select non-stacking tracking spells
...
#define SPELL_ATTR_EX2_CAN_TARGET_DEAD            0x00000001            // 0 can target dead unit or corpse
#define SPELL_ATTR_EX2_UNK1                       0x00000002            // 1
#define SPELL_ATTR_EX2_IGNORE_LOS                 0x00000004            // 2 used for detect can or not spell reflected // do not need LOS (e.g. 18220 since 3.3.3)
...
#define SPELL_ATTR_EX2_IS_ARCANE_CONCENTRATION    0x00800000            // 23 Only mage Arcane Concentration have this flag
...
#define SPELL_ATTR_EX2_TRIGGERED_CAN_TRIGGER_PRO  0x40000000            // 30
...
#define SPELL_ATTR_EX3_BLOCKABLE_SPELL            0x00000008            // 3
...
#define SPELL_ATTR_EX3_PLAYERS_ONLY               0x00000100            // 8 can target only players
#define SPELL_ATTR_EX3_TRIGGERED_CAN_TRIGGER_PROC 0x00000200            // 9
...
#define SPELL_ATTR_EX3_DONT_DISPLAY_CHANNEL_BAR   0x00002000            // 13 Clientside attribute - will not display channeling bar
#define SPELL_ATTR_EX3_IS_HONORLESS_TARGET        0x00004000            // 14 "Honorless Target" only this spells have this flag
...
#define SPELL_ATTR_EX3_UNK19                      0x00080000            // 19 during aura proc no spells can trigger (20178, 20375)
...
#define SPELL_ATTR_EX3_DONT_DISPLAY_RANGE         0x40000000            // 30
#define SPELL_ATTR_EX3_UNK31                      0x80000000            // 31

#define SPELL_ATTR_EX4_IGNORE_RESISTANCES         0x00000001            // 0 From TC 3.3.5, but not present in 1.12 native DBCs. Add it to prevent a spell from being resisted.
...
#define SPELL_ATTR_EX4_CAN_CAST_WHILE_CASTING     0x00000080            // 7 In theory, can use this spell while another is channeled/cast/autocast
...
#define SPELL_ATTR_EX4_DAMAGE_DOESNT_BREAK_AURAS  0x00004000            // 14
...
#define SPELL_ATTR_EX4_NOT_CHECK_SELFCAST_POWER   0x00100000            // 20 do not give "more powerful spell" error message
