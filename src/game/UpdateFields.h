...
enum EUnitFields
{
    ...
    UNIT_VIRTUAL_ITEM_SLOT_DISPLAY_01             = OBJECT_END + 0x0020,
    UNIT_VIRTUAL_ITEM_SLOT_DISPLAY_02             = OBJECT_END + 0x0021,
    UNIT_VIRTUAL_ITEM_INFO                        = OBJECT_END + 0x0022,
    UNIT_VIRTUAL_ITEM_INFO_01                     = OBJECT_END + 0x0023,
    UNIT_VIRTUAL_ITEM_INFO_02                     = OBJECT_END + 0x0024,
    UNIT_VIRTUAL_ITEM_INFO_03                     = OBJECT_END + 0x0025,
    UNIT_VIRTUAL_ITEM_INFO_04                     = OBJECT_END + 0x0026,
    UNIT_VIRTUAL_ITEM_INFO_05                     = OBJECT_END + 0x0027,
    ...
    UNIT_FIELD_RESISTANCES_01                     = OBJECT_END + 0x0096,
    UNIT_FIELD_RESISTANCES_02                     = OBJECT_END + 0x0097,
    UNIT_FIELD_RESISTANCES_03                     = OBJECT_END + 0x0098,
    UNIT_FIELD_RESISTANCES_04                     = OBJECT_END + 0x0099,
    UNIT_FIELD_RESISTANCES_05                     = OBJECT_END + 0x009A,
    UNIT_FIELD_RESISTANCES_06                     = OBJECT_END + 0x009B,
    ...
    UNIT_FIELD_POWER_COST_MODIFIER_01             = OBJECT_END + 0x00A8,
    UNIT_FIELD_POWER_COST_MODIFIER_02             = OBJECT_END + 0x00A9,
    UNIT_FIELD_POWER_COST_MODIFIER_03             = OBJECT_END + 0x00AA,
    UNIT_FIELD_POWER_COST_MODIFIER_04             = OBJECT_END + 0x00AB,
    UNIT_FIELD_POWER_COST_MODIFIER_05             = OBJECT_END + 0x00AC,
    UNIT_FIELD_POWER_COST_MODIFIER_06             = OBJECT_END + 0x00AD,
    UNIT_FIELD_POWER_COST_MULTIPLIER              = OBJECT_END + 0x00AE,
    UNIT_FIELD_POWER_COST_MULTIPLIER_01           = OBJECT_END + 0x00AF,
    UNIT_FIELD_POWER_COST_MULTIPLIER_02           = OBJECT_END + 0x00B0,
    UNIT_FIELD_POWER_COST_MULTIPLIER_03           = OBJECT_END + 0x00B1,
    UNIT_FIELD_POWER_COST_MULTIPLIER_04           = OBJECT_END + 0x00B2,
    UNIT_FIELD_POWER_COST_MULTIPLIER_05           = OBJECT_END + 0x00B3,
    UNIT_FIELD_POWER_COST_MULTIPLIER_06           = OBJECT_END + 0x00B4,
